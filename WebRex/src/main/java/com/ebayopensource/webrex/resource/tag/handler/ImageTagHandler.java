...
public class ImageTagHandler extends ResourceTagHandler {
   private static final long serialVersionUID = 9201521075097213317L;

   @Override
   protected ITag createTag() {
      ResourceTag tag = new ResourceTag();
      tag.getModel().setExpectedResourceType(ResourceTypeConstants.IMAGE);
      return tag;
   }
}

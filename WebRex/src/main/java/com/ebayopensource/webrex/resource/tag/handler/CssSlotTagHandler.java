...
public class CssSlotTagHandler extends ResourceTagHandler {
   private static final long serialVersionUID = 3315254169855213646L;

   protected ITag createTag() {
      SlotTag tag = new SlotTag(ResourceTypeConstants.CSS);
      tag.setSlotType(ResourceTypeConstants.CSS);
      return tag;
   }
   ...
   public void setMedia(String media) {
      getModel().setAttribute("media", media);
   }
}
